      ...
      <div className={styles.info}>
        ...
        <div className={styles.account}>
          <Link to={ROUTES.HOME} className={styles.favourites}>
            <svg className={styles["icon-fav"]} fill="inherit" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" id="heart">
          ...
          <Link to={ROUTES.CART} className={styles.cart}>
            <svg className={styles["icon-cart"]} fill="inherit" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" id="bag">
